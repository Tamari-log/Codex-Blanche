...
function getEffectiveSettings(){const systemPrompt=typeof dom.systemPrompt?.value==='string'?dom.systemPrompt.value:state.settings.systemPrompt;return {...state.settings,systemPrompt};}
